...
<head>
	...
	<title><dec:title default="Trang chủ" /></title>
      ...
      <link rel ="stylesheet" href = "//code.jquery.com/ui/1.12.1/thems/base/jquery-ui.css">
        ...
        <script src = "<c:url value = '/template/admin/assets/js/jquery.2.1.1.min.js'/>"></script>
           ...
           <script src = "<c:url value = '/template/chung/jquery.twbsPagination.js'/>"></script>
...
<body class ="no-skin">
	...
	<div class="main-container" id="main-container">
		<script type="text/javascript">
			try {
				ace.settings.loadState('main-container', 'fixed')} catch (e) {}
		</script>

		<%@ include file="/common/admin/menu.jsp"%>
		
	   <%@ include file ="/views/admin/new/list.jsp" %>>
